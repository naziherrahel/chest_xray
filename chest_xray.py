...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font.setBold(True)
        font.setWeight(75)
        self.label_2.setFont(QFont('Modak',26))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.frame)
        self.label_3.setGeometry(QtCore.QRect(0,0,200,100))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(65)
        self.label_3.setFont(QFont('Modak',20))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "iPolytech"))
    ...
    def upload_image(self):
        ...
        path=str(path)
        print(path)
        model=load_model('C:\\Users\\nazih\\Downloads\\archive\\chest_xray\\chest_xray.h5') 
